...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // (Mobile menu toggle handled in robust handler below)
      ...
      <article class="pcard reveal visible">
        <div class="pcard-img">
          ...
          <div class="pcard-overlay">
            ...
            ${p.image ? `<span class="pcard-zoom"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;margin-right:4px;"><circle cx="11" cy="11" r="7"/><path d="m21 21-4.3-4.3"/></svg>Vergrössern</span>` : ''}
          </div>
        </div>
      </article>`).join('');
